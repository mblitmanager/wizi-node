...
export declare class StagiaireService {
    ...
    constructor(stagiaireRepository: Repository<Stagiaire>, classementRepository: Repository<Classement>, catalogueRepository: Repository<CatalogueFormation>, formationRepository: Repository<Formation>, quizRepository: Repository<Quiz>, participationRepository: Repository<QuizParticipation>, userRepository: Repository<User>, partenaireRepository: Repository<Partenaire>, rankingService: RankingService, agendaService: AgendaService, mediaService: MediaService);
