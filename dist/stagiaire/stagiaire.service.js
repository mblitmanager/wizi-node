...
let StagiaireService = class StagiaireService {
    constructor(stagiaireRepository, classementRepository, catalogueRepository, formationRepository, quizRepository, participationRepository, userRepository, partenaireRepository, rankingService, agendaService, mediaService) {
...
exports.StagiaireService = StagiaireService = __decorate([
    ...
    __param(7, (0, typeorm_1.InjectRepository)(partenaire_entity_1.Partenaire)),
