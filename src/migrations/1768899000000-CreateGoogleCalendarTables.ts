...
export class CreateGoogleCalendarTables1768899000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    // Les tables et contraintes sont supposées exister déjà ou sont gérées par d'autres moyens.
    // Cette migration est commentée pour éviter les erreurs de duplication.
